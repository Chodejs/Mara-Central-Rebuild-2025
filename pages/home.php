<main class="flex-grow">
    ...
    <section class="py-20 md:py-32 bg-gray-900">
        <div class="container mx-auto px-6 text-center">
            ...
            <a href="index.php?p=lessons" class="bg-teal-500 hover:bg-teal-600 text-white font-bold text-lg px-8 py-4 rounded-lg transition-transform transform hover:scale-105 inline-block">Explore Lessons</a>
        </div>
    </section>
